...
public class LobbyPanel extends JPanel {
	...
	public LobbyPanel(ClientController cc, String server){
		...
		lblMeImg.setIcon(new ImageIcon(LobbyPanel.class.getResource("/images/profile/BmanProfileBlue.png")));
		...
		lblPl1Img.setIcon(new ImageIcon(LobbyPanel.class.getResource("/images/profile/BmanProfileBlack.png")));
		...
		lblPL2Img.setIcon(new ImageIcon(LobbyPanel.class.getResource("/images/profile/BmanProfileBlue.png")));
		...
		lblPl3Img.setIcon(new ImageIcon(LobbyPanel.class.getResource("/images/profile/BmanProfileR.png")));
		...
		lblPl4Img.setIcon(new ImageIcon(LobbyPanel.class.getResource("/images/profile/BmanProfileW.png")));
